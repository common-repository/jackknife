...
final class JKNLayouts {
	 ...
	 * @return string
	 */
	static function grid(array $items, int $n_cols, callable $format_cb,
		string $grid_class='', string $row_class='', string $col_class='',
		bool $is_inner=false, bool $try_vc=true): string {
